...
//public class KanjiStrokeValid : MonoBehaviour
//{
//    [Header("References")]
...
//    public void ResetStrokeProgress()
//    {
...
//    public void CheckLatestStroke()
//    {
//        if (templatePlayer == null || mouseTracer == null)
//        {
//            Debug.LogWarning("KanjiStrokeValidator: missing references.");
//            return;
//        }

//        int targetStrokeCount = templatePlayer.GetStrokeCount();

//        if (currentStrokeIndex >= targetStrokeCount)
//        {
//            Debug.Log("All strokes already complete.");
//            return;
//        }

//        List<Vector3> targetStroke = templatePlayer.GetStrokePointsCopy(currentStrokeIndex);
//        List<Vector3> userStroke = mouseTracer.GetLastStrokeCopy();

//        if (userStroke == null || userStroke.Count < 2)
//        {
//            Debug.Log("Try Again: no valid user stroke found.");
//            return;
//        }

//        bool passed = ValidateStroke(userStroke, targetStroke, out float avgDist, out float seDist);

//        Debug.Log($"Stroke {currentStrokeIndex + 1}: avg={avgDist:F3}, start/end={seDist:F3}, pass={passed}");

//        if (!passed)
//        {
//            Debug.Log("Try Again");
//            mouseTracer.RemoveLastStroke();

//            if (instructionPlayer != null)
//            {
//                instructionPlayer.ShowInstructionOnly();
//                instructionPlayer.ShowOnlyStroke(currentStrokeIndex);
//            }

//            return;
//        }

//        Debug.Log($"Stroke {currentStrokeIndex + 1} correct.");
//        currentStrokeIndex++;
