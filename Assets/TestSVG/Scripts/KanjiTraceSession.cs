...
public class KanjiTraceSession : MonoBehaviour
{
    [Header("References")]
    ...
    [Tooltip("Lower is stricter. Checks where the stroke starts and ends")]
    ...
    public void CheckCurrentKanji()
    {
        ...
        {
            Debug.LogWarning("KanjiTraceSession: Missing references.");
            return;
        }
        ...
        {
            Debug.LogWarning("KanjiTraceSession: No target strokes found.");
            return;
        }
